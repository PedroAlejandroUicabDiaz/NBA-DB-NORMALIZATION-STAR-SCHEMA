...
def insertion():
    ...
    try:
        ...
        cursor.executemany(mySql_insert_query, records_to_insert)
        connection.commit()
        print(cursor.rowcount, "Record inserted successfully into Players table")
    ...
    try:
        ...
        cursor.executemany(mySql_insert_query, records_to_insert)
        connection.commit()
        print(cursor.rowcount, "Record inserted successfully into Arenas table")
    ...
    try:
        ...
        cursor.executemany(mySql_insert_query, records_to_insert)
        connection.commit()
        print(cursor.rowcount, "Record inserted successfully into Cities table")
    ...
    try:
        ...
        mySql_insert_query = """INSERT INTO Teams (TEAM_ID, TEAM_NAME, ABBREVIATION, NICKNAME,YEARFOUNDED,MIN_YEAR, MAX_YEAR, CITY_ID, OWNER,GENERALMANAGER,HEADCOACH,LEAGUE_ID,DLEAGUEAFFILIATION) 
        ...
        cursor.executemany(mySql_insert_query, records_to_insert)
        connection.commit()
        print(cursor.rowcount, "Record inserted successfully into Teams table")
    ...
    try:
        ...
        mySql_insert_query = """INSERT INTO Games (GAME_ID, GAME_STATUS_TEXT, SEASON_ID, HOME_TEAM_ID, PTS_home, FG_PCT_home, FT_PCT_home, FG3_PCT_home, AST_home, REB_home, VISITOR_TEAM_ID, PTS_away, FG_PCT_away, FT_PCT_away, FG3_PCT_away, AST_away, REB_away, HOME_TEAM_WINS) 
    ...
    try:
        ...
        cursor.executemany(mySql_insert_query, records_to_insert)
        connection.commit()
        print(cursor.rowcount, "Record inserted successfully into Game_details table")
    ...
    try:
        ...
        cursor.executemany(mySql_insert_query, records_to_insert)
        connection.commit()
        print(cursor.rowcount, "Record inserted successfully into Players_at_team_in_season table")
